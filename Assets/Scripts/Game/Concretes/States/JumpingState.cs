        ...
        public void OnUpdate()
        {
            ...
            if (isGrounded)
            {
                ...
                if (_reader.Click)
                {
                    ...
                    rb.AddForce(Vector2.up * _controller.JumpStats.JumpPower * 1.5f, ForceMode2D.Impulse);
                }
            ...
            {
                playerSprite.Rotate(Vector3.back, _controller.JumpStats.RotateAngleSpeed * 1.5f * Time.deltaTime);
            }
        }
